			...
			<div class="row">
				...
				<div class="span9">
					<div class="well summary">
						<ul>
							<li>
							<span class="count">Welcome，Admin！</span> 以下是文件列表
							</li>
						</ul>
					</div>
					<table class="table table-bordered table-striped">
						...
						<tbody>
						<c:forEach items="${sessionScope.afileList}" var="FileInfo">
							<tr>
								<td>
									${FileInfo.fName}
								</td>
					...
					<div class="pagination">
						<ul>
							<li>
								<a href="alist?up_down=-1&&cho_page=0">&laquo;</a>
							</li>
							<li>
								<a href="alist?up_down=0&&cho_page=1">1</a>
							</li>
							<li>
								<a href="alist?up_down=0&&cho_page=2">2</a>
							</li>
							<li>
								<a href="alist?up_down=0&&cho_page=3">3</a>
							</li>
							<li>
								<a href="alist?up_down=0&&cho_page=4">4</a>
							</li>
							<li>
								<a href="alist?up_down=1&&cho_page=0">&raquo;</a>
							</li>
						</ul>
					</div>   
			  </div>
