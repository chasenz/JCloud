...
<%
	...
	String fName=(String)request.getAttribute("share_fName");
	String fNo=(String)request.getAttribute("share_fNo");
	String fPwd=(String)request.getAttribute("share_fPwd");
%>	
	<div class="container">
		<div class="navbar">
            ...
            <div class="span9">
					...
					action="#" method="post">
						<fieldset>
							...
							<div class="control-group">
								<label class="control-label" for="input01">文件号：</label>
								<div class="controls">
									<p class="help-block"><%out.print(fNo);%></p>
								</div>
							</div>
							
							<div class="control-group">
								<label class="control-label" for="input01">提取码：</label>
								<div class="controls">
									<p class="help-block"><%out.print(fPwd);%></p>
								</div>
							</div>
