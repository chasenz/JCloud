...
<%
	...
	String uNo=(String)request.getAttribute("pro-uNo");
	String fSize=(String)request.getAttribute("pro-fSize");
%>	
	<div class="container">
		<div class="navbar">
			...
			<div class="row">
				<div class="span3">
					...
					action="#" method="post">
						<fieldset>
							<legend>你的基本信息如下</legend>	
							
							<div class="control-group">
								<label class="control-label" for="input01">UID：</label>
								<div class="controls">
									<p class="help-block"><%out.print(uNo);%></p>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<p class="help-block"><%out.print(uName);%></p>
								</div>
							</div>
							
							<div class="control-group">
								<label class="control-label" for="input01">云盘大小：</label>
								<div class="controls">
									<p class="help-block"><%out.print(fSize);%></p>
								</div>
							</div>
						</fieldset>
					</form>
