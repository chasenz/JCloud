...
<html lang="en"><!--<![endif]--> 
	...
	<body>
<%
	String result=(String)session.getAttribute("set-result");
	...
	<div class="container">
		<div class="navbar">
            ...
            <div class="span9">
					...
					action="/MyCloud/doSet" method="post">
						<fieldset>
							<legend>完成下列信息确认</legend>	
							
							<div class="control-group">
								<label class="control-label" for="input01">原密码：</label>
								<div class="controls">
									<input  class="input-xlarge" id="input01" name="uPwd" type="password"/>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input  class="input-xlarge" id="input02" name="nuPwd" type="password"/>
								</div>
							</div>
							...
							<div class="control-group">
								...
								<div class="controls">
									<input  class="input-xlarge" id="input03" name="nuPwd2" type="password"/>
								</div>
							</div>
							<label class="label" for="fileInput">结果：<% out.print(result);
															session.setAttribute("set-result", "null"); %></label>			
